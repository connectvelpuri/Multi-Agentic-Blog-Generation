...
class LLMSettings(BaseModel):
    API_KEY: str = Field(default="", validation_alias=AliasChoices(
...
try:
    ...
    import warnings
    warnings.warn(f"Settings failed to load: {e}. Using defaults.")
    app_settings = Settings(llm=LLMSettings(API_KEY=""))
